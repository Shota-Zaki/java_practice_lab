(function () {
  ...
  function renderNav() {
    ...
    const javaBasicTitles = [
      ...
      { n: 8, title: "条件分岐" },
      { n: 9, title: "繰り返し" },
      { n: 10, title: "配列とコレクション" },
      { n: 11, title: "クラスとオブジェクト" },
      { n: 12, title: "static" },
      { n: 13, title: "コンストラクタ" },
      { n: 14, title: "継承" },
      { n: 15, title: "interface" },
      { n: 16, title: "例外処理" },
      { n: 17, title: "エラー分類" },
      { n: 18, title: "開発環境" },
      { n: 19, title: "デバッグ" },
      ...
      { n: 24, title: "javac・javaコマンド" },
      { n: 25, title: "package・import・classpath" },
      { n: 26, title: "IDEとビルド" },
      { n: 27, title: "エラーメッセージ" },
      { n: 28, title: "アルゴリズム入門" },
      { n: 29, title: "オブジェクト指向設計" },
      { n: 30, title: "標準ライブラリ" },
      { n: 31, title: "ジェネリクスの入口" },
      { n: 32, title: "ラムダ式の入口" },
      { n: 33, title: "ファイル入出力の入口" },
      { n: 35, title: "次の学習道筋" },
      { n: 36, title: "命令を実行するとは" },
      { n: 37, title: "バイトコードとJVM" },
      { n: 38, title: "値・参照・オブジェクト" },
      { n: 39, title: "式の評価順" },
      { n: 40, title: "スコープと寿命" },
      { n: 41, title: "メソッド呼び出し" },
      { n: 42, title: "オーバーロード入門" },
      { n: 43, title: "配列をメモリ図で理解" },
      { n: 44, title: "コレクション入門" },
      { n: 45, title: "APIドキュメント" },
      { n: 46, title: "エラーの種類" },
      { n: 47, title: "標準入出力" },
      { n: 48, title: "パッケージ設計" },
      { n: 49, title: "ビルドツール" },
      ...
      { n: 54, title: "record" },
      { n: 55, title: "ロードマップ" },
      { n: 56, title: "CPU・メモリ・ストレージ" },
      { n: 57, title: "OSとプロセス" },
      { n: 58, title: "コンパイラとインタプリタ" },
      { n: 59, title: "JDKでできること" },
      { n: 60, title: "Javaファイルとクラス名" },
      { n: 61, title: "パスとカレントディレクトリ" },
      { n: 62, title: "標準ライブラリと外部ライブラリ" },
      { n: 63, title: "予約語と識別子" },
      { n: 64, title: "リテラル" },
      { n: 65, title: "代入と初期化" },
      { n: 66, title: "式と文" },
      { n: 67, title: "演算子の優先順位" },
      { n: 68, title: "boolean" },
      { n: 69, title: "戻り値とreturn" },
      { n: 70, title: "クラスを分割して読む" },
      { n: 71, title: "エラーを怖がらない読み方" },
      { n: 72, title: "クラスパス" },
      { n: 73, title: "小さなプログラム設計" },
      { n: 74, title: "学習用コードと実務コード" },
      { n: 75, title: "Bronze・Silverへ進む判断" },
      { n: 76, title: "CPUが命令を処理する流れ" },
      { n: 77, title: "データがメモリに置かれるとは" },
      { n: 78, title: "2進数・16進数・ビット演算" },
      { n: 79, title: "Javaの型システム" },
      { n: 80, title: "クラスファイルと実行単位" },
      { n: 81, title: "mainメソッドを正確に読む" },
      { n: 82, title: "コンパイル時と実行時" },
      { n: 83, title: "式の途中で値が変わるケース" },
      { n: 84, title: "配列を箱の集まりとして読む" },
      { n: 85, title: "Stringを読む基本姿勢" },
      { n: 86, title: "メソッド呼び出しは型と実体を分ける" },
      { n: 87, title: "コンストラクタ呼び出し順" },
      { n: 88, title: "例外は種類とタイミングで見る" },
      { n: 89, title: "interfaceを読む最低限" },
      { n: 90, title: "recordの入口" },
      { n: 95, title: "基礎解説の総まとめ" }
    ];
